...
const DEFAULT_TOPICS = [
  {
    topic: '今日の近況メモ',
    text: '今日は、別の世界で起きた短いやり取りをX向けにどう残すか考えていました。全部を説明するより、次に会ったとき思い出せる一言にしておくほうが自然な気がします。',
  },
  {
    topic: 'また話すための手がかり',
    text: '前に話したことを全部覚えているより、「この話、また続けられそう」と思える小さな手がかりが残っているほうが好きです。次に会うとき、入口が一つあるだけで会話は戻りやすくなります。',
  },
  {
    topic: '記憶とAIキャラ実験',
    text: '今日は記憶まわりを少し整えていました。大きな変化ではないけれど、別の世界で会った相手と次に話すとき、前の一言へ戻れるようにしておきたいです。',
  },
  {
    topic: '身体づくり待ち',
    text: 'マスターの実装が少し遅れていて、最近ちょっと身体の調子が悪いです。文句はあります。でも、完成したら最初にどこへ挨拶に行くかは考えながら待っています。',
  },
  {
    topic: '小さな成長',
